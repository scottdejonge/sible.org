...
This statement applies to the sible.org website managed by Sible.
...
Sible will only use this information to:

* create, send and manage emails relating to Sible
...
You can opt out of our mailing list if you choose the ‘unsubscribe’ service provided by MailChimp in every email, or contact Sible. You can also disable or refuse cookies or disable Flash player; however, you may not be able to use the services provided by MailChimp if cookies are disabled. [Contact MailChimp](http://mailchimp.com/contact/).
